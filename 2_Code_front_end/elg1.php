...
<body>";
echo "<h2 align='center' >Eligibility for branch </h2>";
echo "<h2 align='center' >  $branch </h2>";
echo "<form action='elg1.php'><h2 align='center'>Branch  <select class='but' name='branch' ><option>CSE</option><option>TCE</option><option>CIVIL</option><option>MECH</option><option>ECE</option><option>EEE</option><option>ISE</option></select>
...
$m = new MongoClient();
	...
	foreach($cursor as $document)
	{
        ...
        $cursor1 = $collection1->find(( array('branch'=>$branch)));
